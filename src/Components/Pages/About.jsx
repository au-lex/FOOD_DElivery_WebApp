...
<section >
    ...
    <div>
        ...
        <h1  className='text-[2rem] mb-4 mt-4 font-medium leading-[40px]'>Our Mission</h1>
        <p>
...
<section>
    <div>
        <h1  className='text-[2rem] mt-4 mb-4 font-medium leading-[40px]'>Meet the Team</h1>
        <p>
        ...
        <div>
            ...
            <p className='my-2'>
                 ...
                 <span className='flex space-x-5 justify-center mt-[1rem]'>
                    <span className='h-[50px] w-[50px] pl-[.55rem] pt-[7.6px] pointer  rounded-full border-[2px] block border-gray-400'> 
                 <FaInstagram  className=' text-[1.8rem] text-gray-500'/>
                    </span>
                    <span className='h-[50px] w-[50px] pl-[.6rem] pt-[7px] pointer  rounded-full border-[2px] block border-gray-400'> 
                 < FaFacebookF  className=' text-[1.8rem] text-gray-500'/>
                    </span>
                    <span className='h-[50px] w-[50px] pl-[.6rem] pt-[7px] pointer  rounded-full border-[2px] block border-gray-400'> 
                 < FaTwitter className=' text-[1.8rem] text-gray-500'/>
                    </span>
                 </span>
        </div>
    </div>
